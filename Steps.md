...
## How It Works
```
You type:   "create a branch called feature/git_ai_attibutes
...
```bash
mkdir ai-devops-Github_repo && cd ai-devops-Github_repo
```
...
3. Add deadsnakes repository (important)
This repo provides newer Python versions:
...
```bash
1. Install venv package for Python 3.11
sudo apt update
sudo apt install python3.11-venv -y
2. (Recommended) Install distutils
sudo apt install python3.11-distutils -y
3. Remove broken venv (if any)
rm -rf venv
4. Create venv again
...
def get_input():
    ...
    print("\n🤖 GitHub AI Agent —ai-devops-Github_repo")
    print("="*50)
...
```
create a new branch called feature/ai-devops-ai-devops-Github_repo
...
```
create a file called ai-devops-Github.md in branch feature/ai-devops-Github
in ai-devops-series repo with this content:
# Day 2 - GitHub MCP Agent
This file was created by an AI DevOps agent.
Branch: feature/ai-devops-Github
Series: AI DevOps Github_repo
DONE
```
...
title: "feat: add ai-devops-Github_repo notes from AI agent"
from branch feature/ai-devops-Github_repo into main
DONE
```
